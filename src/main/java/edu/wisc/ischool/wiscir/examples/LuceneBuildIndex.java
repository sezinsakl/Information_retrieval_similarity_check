...
public class LuceneBuildIndex {
	...
	public LuceneBuildIndex(Similarity similarity) {
		super();
		this.similarity = similarity;
	}
	...
	public void build() {
        try {
            ...
            String pathCorpus = "/Users/sezinsaklioglu/Desktop/LuceneTutorial/example_corpus.gz";
            String pathIndex = "/Users/sezinsaklioglu/Desktop/LuceneTutorial/example_index_lucene";
